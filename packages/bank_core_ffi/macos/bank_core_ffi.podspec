...
# Run `pod lib lint bank_core_ffi.podspec` to validate before publishing.
#
Pod::Spec.new do |s|
  s.name             = 'bank_core_ffi'
  s.version          = '0.0.1'
...
A new Flutter FFI plugin project.
  ...
  # s.resource_bundles = {'bank_core_ffi_privacy' => ['Resources/PrivacyInfo.xcprivacy']}
